Allez! 
Encore une petite synthèse pour simplifier la vie à notre petite franc-maçonnerie!
Comme d'hab': merci de me signaler erreurs et lacunes.

Je ne reprend pas ici :
- les marques d'exportation que j'ai déjà traitées ici
- les « marques » (en fait les noms de coopérative ou d'administration) horlogères soviétiques de l'époque pré-industrielle.

Vous trouverez ici :
1. D'abord un classement en cyrillique renvoyant à la transcription latine (telles qu'employées par les francophones) et à la fabrique.
2. Ensuite un classement alphabétique des transcriptions latines (telles qu'employées par les francophones)  renvoyant à la transcription cyrillique et à la fabrique.
3. Enfin, le plus complet, un classement par fabrique (avec quelques indications sur la marque : type de montre, période de production, etc.)
